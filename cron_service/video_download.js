...
_f['D1'] = function(cbk) {
	...
	var s1 = 'ffmpeg -ss ' + s + ' -i ' + file_video + ' -vf scale=-1:' +  180 + '  -preset ultrafast ' +  CP.data.DR2 + 180 + '_' + s + '_.png' +' -y ;';
	var s2 = 'ffmpeg -ss ' + s + ' -i ' + file_video + ' -vf scale=-1:' +  90 + '  -preset ultrafast ' + CP.data.DR2 + 90 + '_' + s + '_.png'+' -y ;';
	var s3 = 'ffmpeg -ss ' + s + ' -i ' + file_video + ' -vf scale=-1:' +  360 + '  -preset ultrafast ' +  CP.data.DR2 + 360 + '_' + s + '_.png'+' -y ;';
